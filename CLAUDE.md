...
The design source of truth is `BRIEF.md`. The knowledge operating manual is `docs/knowledge/CLAUDE-BRIEF.md`. Do not contradict either without flagging it first.
...
docs/
  ...
  knowledge/
    CLAUDE-BRIEF.md            — full knowledge operating manual
...
| Skill | File | Use when |
|---|---|---|
| Prompt Rewriter | `.claude/skills/prompt-rewriter/SKILL.md` | Sharpening a rough instruction before acting on it |
| Figma Fidelity | `.claude/skills/figma-fidelity/SKILL.md` | Translating Figma nodes to CSS with measured accuracy |
| Design Critic | `.claude/skills/design-critic/SKILL.md` | Auditing design, typography, spacing, or visual hierarchy |
| Frontend Implementer | `.claude/skills/frontend-implementer/SKILL.md` | Writing or refactoring HTML/CSS/JS for this project |
...
`.claude/prompts/` contains: `design-critique.md`, `figma-audit.md`, `figma-to-code.md`, `frontend-refactor.md`, `layout-system.md`, `typography-review.md`, `spacing-review.md`, `responsive-audit.md`, `copy-refinement.md`, `strategy-review.md`, `prompt-rewriter.md`
...
**After:** run the measurement verification loop in `docs/knowledge/CLAUDE-BRIEF.md §2c`. Report measured values with ≤1px tolerance. Do not claim pixel-perfect without evidence.
