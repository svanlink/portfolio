...
description: >
  ...
  Claude to improve it before acting.
---
...
- **Verification gate** — "Verify with the measurement loop in
  `docs/knowledge/CLAUDE-BRIEF.md §2c` before claiming done."

- **Context anchor** — "Read `CLAUDE.md` and the relevant spec files before
  touching any code."
